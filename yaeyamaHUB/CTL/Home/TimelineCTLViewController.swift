//
//  TimelineCTLViewController.swift
//  yaeyamaHUB
//
...
class TimelineCTLViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
  ...
  //  })
        ...
        refreshControl.addTarget(self, action: #selector(TimelineCTLViewController.refresh), for: UIControl.Event.valueChanged)
        ...
        tableView.delegate = self
            ...
            //カスタム属性の追加
        Amplify.Auth.update(userAttribute: AuthUserAttribute(.custom("type"), value: "CTL")) { result in
            do {
...
extension TimelineCTLViewController {
    //tableview要素
